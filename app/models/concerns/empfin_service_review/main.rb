    ...
    def main_loop
      t.each do |row|
        begin ## "t.each"
          ...
          output_row = EmpfinServiceReview::RowReader.get_row_by_original_key(output: o, original_key: short_description)
          ...
          EmpfinServiceReview::CsvWriter.to_csv(input_array: o, csv_filename: 'output-cc-file.csv')
